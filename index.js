                        ...
                        if (res.text !== undefined) {
                            ...
                            if (!obj.liabilities && !obj.tobepaid) {
                                io.sockets.emit('sendinfo', {
                                    code: '0000',
                                    type: 'warn',
                                    msg: ('抓取:' + obj.id + '失败,没有找到该标的信息,耗时：' + spendTime)
                                });
                                ...
                                io.sockets.emit('sendinfo', {
                                    code: '0000',
                                    type: 'suc',
                                    msg: ('抓取成功:   id:' + obj.id + JSON.stringify(obj))
                                });
                ...
                .end(function (err, res) {
                    if (err) {
                        ...
                        if (!isNaN(res.body.Code) || res.body.Code === 0) {
                            if (res.body.Code === 1) {
                                io.sockets.emit('sendinfo', {
                                    code: '0000',
                                    type: 'suc',
                                    msg: ('id:' + obj.id + "   拍拍贷返回状态码" + res.body.Code + "," + res.body.Message)
                                });
                        ...
                        io.sockets.emit('sendinfo', {
                            code: '0000',
                            type: 'suc',
                            msg: ('拍拍贷返回的数据', "id:  " + obj.id + JSON.stringify(res.body))
                        });
